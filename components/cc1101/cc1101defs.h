...
static const uint8_t CC1101_SYNC1 = 0x04; // Sync word, high INT8U
static const uint8_t CC1101_SYNC0 = 0x05; // Sync word, low INT8U
...
static const uint8_t CC1101_FREQ2 = 0x0D; // Frequency control word, high INT8U
static const uint8_t CC1101_FREQ1 = 0x0E; // Frequency control word, middle INT8U
static const uint8_t CC1101_FREQ0 = 0x0F; // Frequency control word, low INT8U
...
static const uint8_t CC1101_WOREVT1 = 0x1E; // High INT8U Event 0 timeout
static const uint8_t CC1101_WOREVT0 = 0x1F; // Low INT8U Event 0 timeout
...
static const uint8_t CC1101_SFSTXON = 0x31; // Enable and calibrate frequency synthesizer (if MCSM0.FS_AUTOCAL=1).
                                        // If in RX/TX: Go to a wait state where only the synthesizer is
                                        // running (for quick RX / TX turnaround).
static const uint8_t CC1101_SXOFF = 0x32; // Turn off crystal oscillator.
static const uint8_t CC1101_SCAL = 0x33; // Calibrate frequency synthesizer and turn it off
                                        // (enables quick start).
static const uint8_t CC1101_SRX = 0x34; // Enable RX. Perform calibration first if coming from IDLE and
                                        // MCSM0.FS_AUTOCAL=1.
static const uint8_t CC1101_STX = 0x35; // In IDLE state: Enable TX. Perform calibration first if
                                        // MCSM0.FS_AUTOCAL=1. If in RX state and CCA is enabled:
                                        // Only go to TX if channel is clear.
static const uint8_t CC1101_SIDLE = 0x36; // Exit RX / TX, turn off frequency synthesizer and exit
                                        // Wake-On-Radio mode if applicable.
static const uint8_t CC1101_SAFC = 0x37; // Perform AFC adjustment of the frequency synthesizer
static const uint8_t CC1101_SWOR = 0x38; // Start automatic RX polling sequence (Wake-on-Radio)
static const uint8_t CC1101_SPWD = 0x39; // Enter power down mode when CSn goes high.
static const uint8_t CC1101_SFRX = 0x3A; // Flush the RX FIFO buffer.
static const uint8_t CC1101_SFTX = 0x3B; // Flush the TX FIFO buffer.
static const uint8_t CC1101_SWORRST = 0x3C; // Reset real time clock.
static const uint8_t CC1101_SNOP = 0x3D; // No operation. May be used to pad strobe commands to two
                                        // INT8Us for simpler software.
//CC1101 STATUS REGSITER
static const uint8_t CC1101_PARTNUM = 0x30;
static const uint8_t CC1101_VERSION = 0x31;
static const uint8_t CC1101_FREQEST = 0x32;
static const uint8_t CC1101_LQI = 0x33;
static const uint8_t CC1101_RSSI = 0x34;
static const uint8_t CC1101_MARCSTATE = 0x35;
static const uint8_t CC1101_WORTIME1 = 0x36;
static const uint8_t CC1101_WORTIME0 = 0x37;
static const uint8_t CC1101_PKTSTATUS = 0x38;
static const uint8_t CC1101_VCO_VC_DAC = 0x39;
...
static const uint8_t CC1101_WRITE_BURST = 0x40; // write burst
static const uint8_t CC1101_READ_SINGLE = 0x80; // read single
static const uint8_t CC1101_READ_BURST = 0xC0; // read burst
static const uint8_t CC1101_BYTES_IN_RXFIFO = 0x7F; // byte number in RXfifo

static const uint8_t CC1101_MARCSTATE_TX = 0x13;
static const uint8_t CC1101_MARCSTATE_TX_END = 0x14;
static const uint8_t CC1101_MARCSTATE_RXTX_SWITCH = 0x15;
