...
void CC1101::set_defaults()
{
  ...
  this->set_mode(false);
  this->write_register(CC1101_IOCFG2, 0x0D);         // GDO2 Output Pin Configuration
  ...
  this->write_register(CC1101_PKTLEN, 0x00);         // Packet Length
  ...
  this->write_register(CC1101_FSCTRL0, 0x23);        // Frequency Synthesizer Control
  ...
  this->write_register(CC1101_MDMCFG3, 0x93);        // Modem Configuration
  this->write_register(CC1101_MDMCFG2, 0x30);        // Modem Configuration
  this->write_register(CC1101_MDMCFG1, 0x02);        // Modem Configuration
  ...
  this->write_register(CC1101_BSCFG, 0x1C);          // Bit Synchronization Configuration
  this->write_register(CC1101_AGCCTRL2, 0xC7);       // AGC Control
  this->write_register(CC1101_AGCCTRL1, 0x00);       // AGC Control
  this->write_register(CC1101_AGCCTRL0, 0xB2);       // AGC Control
  ...
  this->write_register(CC1101_AGCTEST, 0x3C);        // AGC Test
