...
void CC1101::set_defaults()
{
  ...
  this->write_register(CC1101_IOCFG0, 0x0D);         // GDO0 Output Pin Configuration
  ...
  this->write_register(CC1101_PKTLEN, 0x1E);         // Packet Length
  this->write_register(CC1101_PKTCTRL1, 0x04);       // Packet Automation Control
  this->write_register(CC1101_PKTCTRL0, 0x32);       // Packet Automation Control
  this->write_register(CC1101_ADDR, 0x00);           // Device Address
  this->write_register(CC1101_CHANNR, 0x00);         // Channel Number
  this->write_register(CC1101_FSCTRL1, 0x06);        // Frequency Synthesizer Control
  ...
  this->write_register(CC1101_MDMCFG4, 0x67);        // Modem Configuration
  this->write_register(CC1101_MDMCFG3, 0x32);        // Modem Configuration
  this->write_register(CC1101_MDMCFG2, 0x30);        // Modem Configuration
  this->write_register(CC1101_MDMCFG1, 0x00);        // Modem Configuration
  this->write_register(CC1101_MDMCFG0, 0x00);        // Modem Configuration
  this->write_register(CC1101_DEVIATN, 0x14);        // Modem Deviation Setting
  ...
  this->write_register(CC1101_MCSM0, 0x18);          // Main Radio Control State Machine Configuration
  this->write_register(CC1101_FOCCFG, 0x16);         // Frequency Offset Compensation Configuration
  ...
  this->write_register(CC1101_AGCCTRL1, 0x00);       // AGC Control
  this->write_register(CC1101_AGCCTRL0, 0x40);       // AGC Control
  ...
  this->write_register(CC1101_WORCTRL, 0xFB);        // Wake On Radio Control
  this->write_register(CC1101_FREND1, 0xB6);         // Front End RX Configuration
